...
public final class ModDebug {
    ...
    private static void save(List<String> args) throws Exception {
        ...
        String packageName = (String) context.getClass()
                ...
                .invoke(context);
        File targetDir = new File(str("/sdcard/Download/", packageName));
        ...
        GLog.h(str("Save exported to ", targetDir.getAbsolutePath()));
    }
    ...
    private static void load(List<String> args) throws Exception {
        ...
        String packageName = (String) context.getClass()
                .getMethod("getPackageName")
                .invoke(context);
        File sourceDir = new File(str("/sdcard/Download/", packageName));
        ...
        GLog.h("Save imported. Restarting.");
    ...
    private static boolean ensureAllFilesAccess(Object context)
        ...
        GLog.w(
                "Grant All files access, return to the game, then run the command again.");
        return false;
    }
        ...
        try {
            ...
            if (syncFiles) {
                try {
                    ...
                    // Match the existing import tool: fsync is best effort.
                }
            }
        } finally {
            try {
