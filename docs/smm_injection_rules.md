...
It does not install the full SMM menu or include unrelated combat features.
...
- Keep `--ankh-only` narrow. It exists to provide ModAnkh, ModLastStand, and the Store / Loot / Debug Console tools on older forks.
